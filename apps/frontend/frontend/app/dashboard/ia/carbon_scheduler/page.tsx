                ...
                {!isAdmin ? <AccessDenied /> : loading ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Légende */}
                            <div className="border border-border/40 rounded-xl overflow-hidden bg-gradient-to-br from-muted/5 to-white">
                                <div className="px-3 py-2 bg-muted/20 border-b border-border/40">
                                    <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                                        ...
                                        Guide des niveaux carbone
                                    </p>
                                </div>

                                <div className="p-3 space-y-3">
                                    {(["GREEN", "YELLOW", "RED"] as CarbonLevel[]).map((lvl, idx) => {
                                        const config = {
                                            GREEN: {
                                                color: "emerald",
                                                bg: "bg-emerald-50",
                                                ...
                                                intensity: "< 200 g/kWh",
                                                icon: Leaf,
                                                description: "Énergie propre - Moment idéal pour les workloads intensifs",
                                            },
                                            YELLOW: {
                                                color: "amber",
                                                bg: "bg-amber-50",
                                                border: "border-amber-200",
                                                intensity: "200 - 400 g/kWh",
                                                icon: Zap,
                                                description: "Intensité modérée - Prioriser les tâches critiques",
                                            },
                                            RED: {
                                                color: "red",
                                                bg: "bg-red-50",
                                                ...
                                                intensity: "> 400 g/kWh",
                                                icon: AlertTriangle,
                                                description: "Énergie carbonée - Reporter les workloads non urgents",
                                            },
                                        }[lvl]
                                        ...
                                        return (
                                            <div
                                                key={lvl}
                                                className={cn(
                                                    "flex items-start gap-3 p-2 rounded-lg transition-all duration-200 cursor-help",
                                            ...
                                            >
                                                <div className="flex-shrink-0 mt-0.5">
                                                    <div className={cn(
                                                        ...
                                                        lvl === "GREEN" ? "bg-emerald-100" : lvl === "YELLOW" ? "bg-amber-100" : "bg-red-100"
                                                    )}>
                                                        <Icon className={cn(
                                                            "w-3.5 h-3.5",
                                                            lvl === "GREEN" ? "text-emerald-600" : lvl === "YELLOW" ? "text-amber-600" : "text-red-600"
                                                        )} />
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="flex items-center justify-between flex-wrap gap-1 mb-0.5">
                                                        <div className="flex items-center gap-2">
                                                            <span className={cn(
                                                                ...
                                                                lvl === "GREEN" ? "bg-emerald-500" : lvl === "YELLOW" ? "bg-amber-500" : "bg-red-500",
                                                            )} />
                                                        ...
                                                        <span className={cn(
                                                            ...
                                                            lvl === "GREEN" ? "bg-emerald-100 text-emerald-700" :
                                                                lvl === "YELLOW" ? "bg-amber-100 text-amber-700" :
                                    ...
                                    {/* Ligne de séparation pour info supplémentaire */}
                                    <div className="pt-2 mt-1 border-t border-border/30">
                                        <div className="flex items-center justify-between text-[9px] text-muted-foreground">
                                            <div className="flex items-center gap-1.5">
                                                <Clock className="w-2.5 h-2.5" />
                                                <span>Mise à jour: toutes les 30s</span>
                                            </div>
                                            <div className="flex items-center gap-1.5">
